define('modules/charts/0.0.1/src/modules/no-data-to-display',function(require, exports, module) {
module.exports = function(Highcharts) {
    ...
    chartPrototype.callbacks.push(function(chart) {
        Highcharts.addEvent(chart, 'load', handleNoData);
        Highcharts.addEvent(chart, 'redraw', handleNoData);
    });
