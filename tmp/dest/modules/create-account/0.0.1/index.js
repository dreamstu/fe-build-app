define('modules/create-account/0.0.1/index',['jquery','dialog','core','loadcity','common'],function(require, exports, module) {
var createAccount = {};
var $ =require('jquery');
var dialog =require('dialog');
var core =require('core');
var loadcity =require('loadcity');require('common');
$(function() {
    var mp = $('#mp'),
        email = $('#email'),
        mfctyName = $('#mfctyName'),
