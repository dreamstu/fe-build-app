define('modules/charts/0.0.1/index',function(require, exports, module) {
var charts = function () {
    var UNDEFINED,
        doc = document,
        win = window,
    ...
    defaultOptions = {
        ...
        credits: {
            enabled: true,
            text: 'crm.qipeipu.com',
            href: 'http://crm.qipeipu.com',
            position: {
                align: 'right',
                x: -10,
                verticalAlign: 'bottom',
...
module.exports = {
    initialize: function(options, callback) {
        if (options && Object.prototype.toString.call(options) === '[object Array]') {
            options.forEach(function(pluginName) {
                require.async('./src/' + pluginName, function(obj) {
                    console.log('插件加载完毕：', pluginName);
                    callback(pluginName, obj);
                });
            });
        }
    },
